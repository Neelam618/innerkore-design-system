...
export const FooterMini3: FC<FooterMini3Types> = ({
    ...
    navTxt1, navTxt2, navTxt3, navTxt4,
}) => {
    return (
            ...
            <div>
                <nav>
                    <ul className='flex flex-col md:flex-row justify-center lg:justify-start'>
                        <li><a href={navLink1} className='text-gray-400 text-sm md:mr-8 text-center block'>{navTxt1}</a></li>
                        <li><a href={navLink2} className='text-gray-400 text-sm md:mr-8 text-center block mt-4 md:mt-0'>{navTxt2}</a></li>
                        <li><a href={navLink3} className='text-gray-400 text-sm md:mr-8 text-center block mt-4 md:mt-0'>{navTxt3}</a></li>
                        <li><a href={navLink4} className='text-gray-400 text-sm mr-0 text-center block mt-4 md:mt-0'>{navTxt4}</a></li>
                    </ul>
                </nav>
            </div>
