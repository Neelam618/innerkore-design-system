    ...
    <div className="bg-black py-16 px-5 md:px-20 xl:px-40">
        <div className='flex justify-between'>
            <div className=''>
                ...
                <p className='text-gray-400 text-xs'>{copyRightTxt}</p>
            </div>
            <div>
                <div className='grid grid-flow-col grid-cols-2 lg:grid-cols-3 grid-rows-4 md:grid-rows-2 lg:grid-rows-1 gap-6 md:gap-20'>
